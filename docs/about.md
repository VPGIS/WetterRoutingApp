...
Am Anfang des Projekts stand der Wunsch, ein Thema zu bearbeiten, das unsere gemeinsamen Interessen verbindet und gleichzeitig einen klaren Raumbezug hat. Da wir beide gerne auf dem Fahrrad unterwegs sind, rückte die Idee einer Routinganwendung schnell in den Vordergrund. Gleichzeitig stellte MeteoSwiss Anfang des Jahres aktuelle Wetterdaten als Open Government Data zur Verfügung. Dadurch entstand der Gedanke, diese Daten nicht nur ergänzend anzuzeigen, sondern direkt in die Routenberechnung einzubeziehen.
